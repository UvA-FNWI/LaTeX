...
- Displayed formulas go between <pre><code class='tex'>\[ ... \]</code></pre>
- In **math mode** spaces you type are ignored
- Format your code the same ways the text is supposed to be typeset, i.e. put the \[- and \]-commands on a seperate code line. 
