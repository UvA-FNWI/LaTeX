...
<ol>
    <li>  Gebruik de volgende modelcode.</li>
...
<li> Maak deze opdracht zelfstandig — van alleen maar meekijken leer je niks. </li>

<li>  Submit je werk op Canvas: zowel tex-bestand als pdf-bestand submitten.
    Je log-bestand mag geen LaTeX-errors meer vermelden.
    Deadline: vrijdagavond 15 januari, 24:00 uur. Niet veel
    later sluit deze assigment en kun je niet meer inleveren. </li>
</ol>
