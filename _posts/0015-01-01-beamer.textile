...
h2. Structure of a presentation
...
Previously we used the beamer theme @Copenhagen@. More themes can be found in the "Beamer Theme Matrix":http://www.hartwork.org/beamer-theme-matrix/. Try adding the following lines in the preamble.
...
A beamer template in the style of the University of Amsterdam can be found "here":http://bliggy.net/UvABeamer.html.

h2. Sample presentation

On Blackboard a sample @.tex@ document can be found which you can use for your presentation.

h2. Tips for a short presentation

h4. Isolate the main subject and make sure to cover it early in your presentation.
...
h4. Use pictures instead of text
...
h4. Examples instead of abstract definitions
