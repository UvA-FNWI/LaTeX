...
\usecolortheme{...}
```
You can choose which theme and colour you would like from the very handy [Beamer Theme Matrix](https://hartwork.org/beamer-theme-matrix/). You can then fill in the names of the theme an colour you choose on the dots. You can also use the UvA beamer theme, which can be downloaded [here](https://github.com/UvA-FNWI/LaTeX/blob/gh-pages/week3/uvamath/BeamerthemeUvA-FNWI.zip).
