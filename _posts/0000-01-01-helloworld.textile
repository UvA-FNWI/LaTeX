...
p. We gaan er bij de eerste opdracht van uit dat je op een computer werkt met toegang tot TeXworks. Om LaTeX zelf te installeren zie de les "Thuis installeren":{{site.baseurl}}{% post_url 0000-06-01-installatie %}.
