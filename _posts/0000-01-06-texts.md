...
special characters: using commands and (sometimes) using your keyboard.

### Commands

The first way to enter special characters is by using LaTeX commands. A
...
Remember also that the default paragraph break in LaTeX is to start a new line, with no empty line in between, and indent this. You can use the package `parskip` to change this to a new line with an empty line in between and no indentation.
...
of numbers, you can load the package `enumitem`, you can find the documentation for this package <a href="https://ctan.org/pkg/enumitem"> here</a> at the LaTeX package database CTAN.
