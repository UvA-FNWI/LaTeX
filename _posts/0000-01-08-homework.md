...
The homework assignment is in Dutch. If you're not a native speaker please contact your teacher.

<div class="panel panel-primary">
<h3 class="panel-heading panel-title"> Opdracht 1 </h3>
<div class="panel-body">
Zet een huiswerkopgave van Verzamelingen en Getallen of Analyse op de Lijn in LaTeX. Kies zelf welke het wordt. Zorg dat je een opgave uitkiest met een beetje LaTeX-uitdaging. Je levert een tex bestand in in Canvas bij Assignments.  
...
3. Submit je werk op Canvas: zowel tex-bestand als pdf-bestand submitten. Je log-bestand mag geen LaTeX-errors meer vermelden.
