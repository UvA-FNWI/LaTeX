...
title: Huiswerk
category: week1
description: Een huiswerkopgave LaTeX'en en LaTeX thuis installeren.
---
...
# Installeer een "LaTeXdistributie":{{site.baseurl}}{% post_url 0000-06-01-installatie %} op je eigen computer.
...
#2 Zet de uitwerking van <a href="stochastiek.pdf">de eerste drie opgaven van huiswerkset 5 van Stochastiek 1</a> in LaTeX. Maak deze opdracht zelfstandig — van alleen maar meekijken leer je niks.
# Submit je werk op Blackboard: zowel tex-bestand, log-bestand als pdf-bestand submitten. Je log-bestand mag geen LaTeX-errors meer vermelden. Deadline: zondagavond 10-1, 24:00 uur. Niet veel later sluit deze assigment en kun je niet meer inleveren. Niet ingeleverd? Dan geen feedback.
