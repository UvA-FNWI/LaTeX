...
* @vbComputeralgebra-LaTeX.tex@ -- the template for this class' report

*2. Rename @vbComputeralgebra-LaTeX.tex@ to a suitable name.*
Open the file. 
You write your report in this file.

*3. Fill in some details.*
The file @vbComputeralgebra-LaTeX.tex@ starts with loading the uvamath class and some necessary packages.
